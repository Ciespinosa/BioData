...
dta <- read_excel("2._data/VertebradosRT1.xlsx", sheet = "Ubicacion")
clase <- read_excel("2._data/VertebradosRT1.xlsx", sheet = "Taxonomia")
tipo <- read_excel("2._data/VertebradosRT1.xlsx", sheet = "Bibliografia")
